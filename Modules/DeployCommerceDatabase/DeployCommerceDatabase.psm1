...
function Invoke-DeployCommerceDatabaseTask {
    ...
    param(
        ...
        [string]$CommerceServicesDbId,
		[Parameter(Mandatory=$false)]
        [string]$CommerceServicesDbPw,
		[Parameter(Mandatory=$true)]
	...
	#The below is no longer necessary if you installed the SqlServer PS module
	#Add-SQLPSSnapin;
	...
	if ($CommerceServicesDbId -eq $null){
		Write-Host "Using Trusted Connection...";
