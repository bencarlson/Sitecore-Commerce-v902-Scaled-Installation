        ...
        if ($PSCmdlet.ShouldProcess($Name, $Action)) {
            switch ($Action) {
                ...
                'Create-Website' {
                    ...
                    New-WebBinding -Name $Name -HostHeader $DnsName -Protocol "https" -SslFlags 1 -Port $Port
                    ...
                    $binding = Get-WebBinding -Name $Name -HostHeader $DnsName -Protocol "https"
...
function dev_reset_iis_sql {
    ...
    #Removing since you can't restart a remote SQL and there is no real reason why you would want to restart SQL anyways
...
# MTgwMzEyMDc0MjE0WjAjBgkqhkiG9w0BCQQxFgQU3RCjoNZd/lDBK3FJEyhncmLf
# cMwwDQYJKoZIhvcNAQEBBQAEggEANsPgCAmRoJu5g4pYk5OM0WMyuiR6gTcfCJXL
# 20iNtAEpqLh4+8z3i7esK1zIPas9zJ2d4WPP5ptv9sbP04o4C4FZjbsoZ5PBqJMI
# F2uYrEu8/uBEZonypWGQ14QTCMsdc4DnORTeAIeVa8zJ7c0jalf9Aj1QXbQkmSZ4
# qEVwn5TPyow6qmQmQueiL3PnjOP7ivBDqY3lbvOeuRXFuWX5yaOQvTny56yTgm2a
# ZyAJCLqidicNYNUeS3og1a5yx12MSZ3bPsqhrZ+U2c0AZJNOE1+OPt8wUYDQ1PuF
# 7pmYbbHCClf6tHiDkzDECzlQWcFxpDR2jl71igVQhS0WOa01jg==
